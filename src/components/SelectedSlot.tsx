...
const SLOT_COLORS: Record<string, string> = {
  ...
  Utility: 'border-purple-500/60 bg-purple-900/20',
}
...
export function SelectedSlot({
  ...
  return (
    <div className={`flex-1 min-w-[90px] rounded-xl border-2 ${SLOT_COLORS[modifier.category]} p-2 flex flex-col gap-1.5`}>
      ...
      <p className="text-xs font-semibold text-white leading-tight line-clamp-2">{modifier.name}</p>
